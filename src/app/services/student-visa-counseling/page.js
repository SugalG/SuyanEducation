  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white mt-24">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        {/* CTA Section */}
        <div className="mt-32 text-center bg-gradient-to-r from-red-50 to-blue-50 rounded-3xl p-12">
          <h3 className="text-3xl font-bold mb-6 bg-gradient-to-r from-red-600 to-blue-950 bg-clip-text text-transparent">
