  ...
  const levels = [
    {
      ...
      description: "Master basic Japanese greetings, hiragana, katakana, and 100 kanji characters",
      duration: "3 Months",
      focus: ["Hiragana & Katakana", "Basic Greetings", "Simple Conversations", "100 Kanji"],
      color: "from-blue-400 to-blue-200"
    },
    {
      level: "N4",
      title: "Elementary Level",
      description: "Understand basic Japanese used in everyday situations and written in simple vocabulary",
      duration: "3 Months",
      focus: ["Daily Conversations", "Sentence Patterns", "300 Kanji", "Basic Grammar"],
      color: "from-green-400 to-green-200"
    },
    {
      level: "N3",
      title: "Intermediate Level",
      description: "Comprehend Japanese used in everyday situations to a certain degree",
      duration: "4 Months",
      focus: ["News Headlines", "Business Japanese", "1000 Kanji", "Workplace Communication"],
    ...
    },
    {
      ...
      duration: "5 Months",
      focus: ["University Lectures", "Professional Emails", "2000 Kanji", "Cultural Nuances"],
      color: "from-orange-400 to-orange-200"
    },
    {
      level: "N1",
      title: "Advanced Level",
      description: "Understand Japanese used in a wide variety of circumstances",
      duration: "6 Months",
      focus: ["Academic Japanese", "Technical Documents", "2100+ Kanji", "Native-level Fluency"],
  ...
  const teachingMethods = [
    {
      ...
      description: "Live instructor-led classes with real-time feedback and interaction",
      features: ["Small batch sizes (max 10 students)", "Native Japanese teachers", "Interactive activities", "Pronunciation correction"]
    },
    {
      title: "Digital Learning Platform",
      description: "Access to comprehensive online resources and practice materials",
      features: ["24/7 Video lessons", "Practice exercises", "Progress tracking", "Mobile app access"]
    },
    {
      title: "Cultural Immersion",
      description: "Learn language through cultural context and real-life scenarios",
      features: ["Japanese movie screenings", "Cultural workshops", "Guest lectures", "Virtual tours"]
    },
    {
      title: "Practical Application",
      description: "Focus on real-world usage and practical communication skills",
      features: ["Role-playing exercises", "Interview preparation", "Business scenarios", "Daily life situations"]
    }
  ];
  ...
  const successStories = [
    {
      ...
      quote: "The structured approach helped me achieve N2 in 14 months and secure my dream job."
    },
    {
      name: "Priya Sharma",
      level: "JLPT N1",
      achievement: "Tokyo University Scholarship",
      quote: "Cultural immersion sessions made the transition to Japan seamless and enjoyable."
    },
    {
      name: "Rohan Mehta",
      level: "JLPT N3",
      achievement: "Moved to Osaka as Engineer",
      quote: "Real-world conversation practice prepared me perfectly for workplace communication."
    }
  ];
    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-red-50">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative text-center mb-16">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              ...
              <span className="block text-gray-800 mt-2">For Study & Career in Japan</span>
            </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Progress through five comprehensive levels following Japan's official JLPT certification framework
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Each level includes focused training on all essential language skills
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <CurriculumCard
            ...
            skills={["Hiragana/Katakana", "Kanji Recognition", "Reading Comprehension", "Business Writing"]}
            icon="BookOpen"
            color="blue"
          />
          <CurriculumCard
            ...
            skills={["Pronunciation", "Conversation Practice", "Listening Comprehension", "Accent Reduction"]}
            icon="Mic"
            color="red"
          />
          <CurriculumCard
            ...
            skills={["Business Etiquette", "Cultural Nuances", "Social Customs", "Workplace Norms"]}
            icon="Users"
            color="green"
          />
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="bg-gradient-to-r from-red-600 to-blue-900 rounded-3xl p-12 text-center text-white">
          ...
          <div className="">
            <Link className="px-8 py-4 bg-white text-red-600 font-semibold rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300" href="/contact">
              Join Us Now!!!
            </Link>
