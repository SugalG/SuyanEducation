...
import { BookOpen, GraduationCap, Briefcase, Award, Target, ChevronRight } from "lucide-react";
        ...
        <aside className="lg:w-1/3 ">
          <div className="lg:sticky lg:top-40">
            <div className="bg-gradient-to-br from-white via-red-50/50 to-blue-50/50 rounded-2xl border border-gray-200 shadow-lg p-6">
              <div className="mb-6">
                <h4 className="text-xl font-bold text-gray-900 mb-2">On this page</h4>
              ...
              <nav className="space-y-2">
                ...
                >
                  <div className={`w-2 h-2 rounded-full ${
                    activeSection === "introduction" ? "bg-red-500" : "bg-gray-300"
                  }`}></div>
                ...
                {whyPoints.length > 0 && (
                  ...
                  >
                    <div className={`w-2 h-2 rounded-full ${
                      activeSection === "why-study" ? "bg-red-500" : "bg-gray-300"
                    }`}></div>
                ...
                {destination.education && (
                  ...
                  >
                    <div className={`w-2 h-2 rounded-full ${
                      activeSection === "education" ? "bg-red-500" : "bg-gray-300"
                    }`}></div>
                ...
                {fields.length > 0 && (
                  ...
                  >
                    <div className={`w-2 h-2 rounded-full ${
                      activeSection === "fields" ? "bg-red-500" : "bg-gray-300"
                    }`}></div>
                ...
                {visaUpdates.length > 0 && (
                  ...
                  >
                    <div className={`w-2 h-2 rounded-full ${
                      activeSection === "visa" ? "bg-red-500" : "bg-gray-300"
                    }`}></div>
                  ...
                  <Reveal key={i} delay={i * 0.1}>
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-100 transition-all group">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 mb-2">{field}</h3>
                          <p className="text-gray-600 text-sm">
                            High-demand programs with excellent career outcomes for graduates.
                          </p>
                        </div>
                      </div>
                    </div>
