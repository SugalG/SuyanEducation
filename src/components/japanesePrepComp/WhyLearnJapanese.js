  ...
  const benefits = [
    {
      ...
      description: "JLPT certification opens doors to prestigious Japanese universities with scholarships"
    },
    {
      icon: Briefcase,
      title: "Career Opportunities",
      description: "300,000+ Japanese companies globally prefer Japanese-speaking professionals"
    },
    {
      icon: Globe,
      title: "Global Advantage",
      description: "Japan is the 3rd largest economy with immense technological innovation"
    },
    {
      icon: Home,
      title: "Settle in Japan",
      description: "Language proficiency significantly improves visa approval chances"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Beyond language - a gateway to education, career, and life opportunities in Japan
          </p>
        </div>
