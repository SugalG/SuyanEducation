                  ...
                  >
                    ...
                    {service.highlight && (
                      <div className="absolute -top-2 left-3 sm:left-4 z-10">
                        <div className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-red-600 to-blue-700 text-white text-xs font-semibold rounded-full shadow whitespace-nowrap">
                          {service.highlight}
                        </div>
                      </div>
                    )}
